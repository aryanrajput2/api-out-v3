...
const PREDEFINED_KEYS = [
  ...
  "31342102eb6bab-5325-42ed-aa1f-92ffc7792178",
  "6116982da6b759-28f8-4cdf-b210-04cb98116165",
  "611722298324c4-5043-4469-8e94-837905c92b57",
...
async function reviewRoom(optionId, correlationId, searchDisplayPrice, isAutoRetry = false) {
  ...
  try {
    ...
    if (upstreamFailed) {
      ...
      // Per-attempt guard (not global): every fresh user-initiated review gets its own
      // recovery; isAutoRetry is only true on the recursive retry below (prevents looping).
